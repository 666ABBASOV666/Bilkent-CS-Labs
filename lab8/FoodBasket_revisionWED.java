public class FoodBasket_revisionWED {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // revisionWED Test (free favorite food)
        System.out.println("\n--------Revision Tests--------");

        Order order6 = new Order(2, food3);
        order6.checkout();
        System.out.println(order6);

        u2.setFavoriteFood(food3);
        u2.addNewOrder(order6);
        System.out.println("");
        ...
        Adding a new order of Cheesecake to Ajda Pekkan...
        Cheesecake is Ajda Pekkan's favorite food!
        Ajda Pekkan lost the chance.
