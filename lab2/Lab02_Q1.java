...
public class Lab02_Q1
{
    ...
    {   
        ...
        System.out.printf("%19.3f ", area);

        System.out.println();

        circumference = (width + height) * 2;
        System.out.printf ( "The circumference of the rectangle is");
        System.out.printf("%10s", ":" );
        System.out.printf("%19.3f ", circumference);

        System.out.println();

        diagonal = ( width * width) + (  height * height);
        diagonal2 = Math.sqrt(diagonal);
        System.out.printf ( "The diagonal of the rectangle is");
        System.out.printf("%15s", ":" );
        System.out.printf("%19.3f ", diagonal2);
        System.out.println();
